...
// ENVIAR UN EMAIL DE AVISO AL CANDIDATO CUANDO SE ACEPTA O RECHAZA SU CANDIDATURA
const avisoCandidato = async ({ email, nombre, titulo, empresa, puesto, mensaje }) => {
  const htmlConfirmar = `
  ...
  <div style="text-align: center; margin: 20px 0 30px;"><span style="font-weight: bold; color: #100e17; font-size: 30px; margin-left: 10px;">El puesto para ${puesto} en la empresa ${empresa}</span></div>
  ...
  <p><a style="background: #100e17; color: white; font-weight: 500; display: inline-block; padding: 10px 35px; margin: 6px 8px; text-decoration: none; border-radius: 2px;" href="${process.env.FRONTEND_URL}" target="_blank" rel="noopener">Ver puestos similares</a></p>
  <p style="color: #757575; font-family: 'Open Sans', Roboto, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; letter-spacing: normal;">Si tu no postulastes, puedes ignorar el mensaje.</p>
